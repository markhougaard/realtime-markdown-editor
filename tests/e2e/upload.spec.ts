...
test.describe('File Upload - UI & Elements', () => {
  ...
  test('file input only accepts .md, .markdown, .txt files', async ({
    page,
  }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
...
test.describe('File Upload - Drag and Drop UI', () => {
  test('drag and drop overlay appears when dragging files', async ({
    page,
  }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
  ...
  test('drag and drop overlay disappears when drag leaves', async ({
    page,
  }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
  ...
  test('drag and drop overlay has correct styling', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
  ...
  test('drag and drop overlay displays drop message', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
...
test.describe('File Upload - Handler Verification', () => {
  ...
  test('file input accepts markdown files', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
  ...
  test('file input accepts markdown format files', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
  ...
  test('file input accepts text files', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
...
test.describe('File Upload - DOM Structure', () => {
  ...
  test('file input is part of editor page', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
  ...
  test('split pane layout contains upload button', async ({ page }) => {
    await createTestDocument(page)
    await waitForEditorReady(page)
