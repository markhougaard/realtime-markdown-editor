...
test('Homepage: auto-redirects to new document', async ({ page }) => {
  // Visit homepage
  await page.goto('/')
...
test('Homepage: each visit creates a new document', async ({ page }) => {
...
test('Homepage: editor and preview are visible', async ({ page }) => {
...
test('Homepage: split pane layout is correct', async ({ page }) => {
